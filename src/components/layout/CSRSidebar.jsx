...
const CSR_ROUTES = [
  ...
  { path: '/csr/activities' },
  { path: '/csr/activities/new' },
  { path: '/csr/activities/:id/edit' },
  { path: '/csr/reports' },
  { path: '/csr/reports/new' },
  { path: '/csr/reports/:id/edit' },
  { path: '/csr/contacts/new' },
  { path: '/csr/contacts/:id/edit' },
  { path: '/csr/expenses/new' },
